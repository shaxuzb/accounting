...
import type { PurchaseReportRow } from "../types/type";

type Row = PurchaseReportRow & { indexId: number };
...
export default function PurchaseReportPage() {
  ...
  const columns: TableColumnsType<Row> = [
    { dataIndex: "indexId", title: t("common.rowNumber"), width: 64 },
    {
      ...
      render: (value, record) => (
        <Link to={`/main/purchases/purchase/${record.id}`}>
          {value || record.id}
        </Link>
      ),
    },
    ...
    { dataIndex: "counterpartyName", title: t("reports.fields.supplier") },
  ...
  return (
    <ReportListPage<PurchaseReportRow>
      report="purchase"
      exportPermission={operationalReportPermissions.purchase.export}
      columns={columns}
      filters={
        <>
          <SearchFilter />
          <SelectFilter
            ...
            placeholder="reports.fields.supplier"
