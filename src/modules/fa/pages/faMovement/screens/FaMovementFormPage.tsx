...
export default function FaMovementFormPage() {
  ...
  const canSubmit = isEdit
    ...
    : permissions.includes(faMovementPermissions.create);
      ...
      <Spin spinning={detailQuery.isLoading && isEdit}>
        <Form layout="vertical" onFinish={formik.handleSubmit}>
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            ...
            {isEdit && isDraft && permissions.includes(faMovementPermissions.confirm) && (
              <PermissionCard permission={faMovementPermissions.confirm}>
                <Button
                  htmlType="button"
            ...
            {isEdit && isDraft && permissions.includes(faMovementPermissions.cancel) && (
              <PermissionCard permission={faMovementPermissions.cancel}>
                <Button
                  htmlType="button"
                  danger
