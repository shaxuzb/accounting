...
export default function CounteryPartyListPage() {
  ...
  const { data, refetch, isLoading, isFetching } = useGetListCounterparty(searchParams);
  ...
  return (
    <div className="w-full">
      ...
      <CounteryPartyAddPage open={isAddOpen} onClose={() => setIsAddOpen(false)} />
      <CounteryPartyAddPage open={isEditOpen} onClose={() => { setIsEditOpen(false); setEditId(null); }} id={editId} />
    </div>
  );
}
