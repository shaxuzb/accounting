...
const ORBIT_CENTER = 320;

const LoadingScreen = () => {
  const isDark = useEffectiveTheme() === "dark";

  const orbitColor = isDark ? "#93c5fd" : "#2563eb";
  const orbitSoftColor = isDark ? "#475569" : "#93c5fd";

  return (
    <div
      className={`min-h-screen w-full overflow-hidden flex items-center justify-center p-6 transition-colors duration-500 ${
        isDark
          ? "bg-[radial-gradient(900px_600px_at_50%_45%,#172554_0%,#0b1120_68%)]"
          : "bg-[radial-gradient(900px_600px_at_50%_45%,#ffffff_0%,#eff6ff_68%,#f8fafc_100%)]"
      }`}
    >
      <div
        ...
        >
          <div className="relative grid place-items-center">
            <div
              ...
              style={{
                background: isDark
                  ? "radial-gradient(circle, rgba(96,165,250,.24), rgba(0,0,0,0) 72%)"
                  : "radial-gradient(circle, rgba(96,165,250,.3), rgba(0,0,0,0) 72%)",
              }}
            />
            <motion.div
              className={`grid h-36 w-36 place-items-center rounded-full ring-1 shadow-2xl sm:h-44 sm:w-44 ${
                isDark
                  ? "bg-slate-950 ring-slate-700/80"
              ...
              animate={{
                boxShadow: isDark
                  ? [
                      ...
                      "0 0 42px 8px rgba(96,165,250,.16)",
                      "0 0 0 0 rgba(96,165,250,0)",
                    ]
                  : [
                      "0 0 0 0 rgba(37,99,235,0)",
                      "0 0 42px 8px rgba(37,99,235,.15)",
                      "0 0 0 0 rgba(37,99,235,0)",
                    ],
              }}
              transition={{
...
//     () => [
//       {
//         label: t("loading.financialReport"),
//         Icon: Calculator,
//         color: "#22c55e",
//       },
...
//       {
//         label: t("loading.projectManagement"),
//         Icon: ClipboardList,
//         color: "#06b6d4",
//       },
...
//       {
//         label: t("loading.businessAnalytics"),
//         Icon: BarChart3,
//         color: "#60a5fa",
//       },
