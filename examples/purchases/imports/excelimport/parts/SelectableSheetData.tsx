import { Button, ConfigProvider, Table, TableColumnType } from "antd";
...
const SelectableSheetData: FC<SelectableSheetDataProps> = (props) => {
  ...
  const tableSource = excelData.map((item, index) => ({ Tartib: index + 1, ...item }));
  ...
  const tableColumnLabels: TableColumnType<ExcelRow>[] = Object.keys(
    ...
    align: "center",
    render: (value: unknown) => <LineClampCell text={value == null ? null : String(value)} />,
  }));
